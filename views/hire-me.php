...
<html>
  <head>
    <meta charset="utf-8">
    <title>Akshat Jain || Hire Me</title>
  ...
  <body>
    ...
    <div class="container-fluid">
  		<div class="row">
  			<div class="col-md-3 col-sm-2 side-fix">
  				<?php require("side-fix.php"); ?>
  			</div>
  			<div class="col-sm-offset-2 col-md-offset-3 hire">
  				<?php require("hire.php"); ?>
  			</div>
  		</div>
	  </div>
